;;; init-org.el --- Configuration files for org -*- lexical-binding: t; -*-
;;; Commentary:
;;; Code:

;;; Location of default bibliography. Used by citar, org-roam, etc.
(defvar dotfiles-bibliography (expand-file-name "~/Reading/library.bib"))
  ...
  (let* ((pdf-file (org-entry-get 1 "NOTER_DOCUMENT"))
	...
	(if (> (length markdown-output) 0)
		(save-excursion (goto-char (point-max))
						...
						(insert "\n# Autogenerated notes start here\n\n" (ap/convert-quotes-to-straight markdown-output)))
